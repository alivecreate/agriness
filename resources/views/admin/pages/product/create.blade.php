                        ...
                        <div class="digital-add needs-validation">
                            ...
                            <div class="form-group">
                                <label for="validationCustom02" class="col-form-label">
                                    Description</label>
                                    <textarea id="editor1" height="200px" name="full_description" cols="14" rows="10"></textarea>
                            </div>
                            ...
                            <div class="row">
                                <div class="form-group col">
                                    <label for="validationCustom01" class="col-form-label pt-0">
                                        Price</label>
                                    <input class="form-control" name="price" id="validationCustom01" type="text">
                                </div>
                                <div class="form-group col">
                                    <label for="validationCustom01" class="col-form-label pt-0">
                                        Discounted Price</label>
                                    <input class="form-control" name="discounted_price" id="validationCustom01" type="text">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <label for="validationCustom02" class="col-form-label"><span>*</span>
                                    ...
                                    <input class="" multiple  type="file" accept="image/*"  
                                        id="images" name="images[]" onchange="previewImages(event)">
