...
@section('content')
    ...
    <section class="about-page section-b-space">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="banner-section"><img src="http://localhost:8000/web/media/lg/1708334281_578.webp"
                            class="img-fluid blur-up lazyload" alt=""></div>
                </div>
                <div class="col-sm-12">
                    <h4>Nurturing Agricultural Excellence, Sowing Seeds of Sustainability, and Cultivating Global Partnerships in the Agricultural Trading Landscape</h4>
                    <p>We started our company in 2022 as a fruit and vegetable supply chain, Angriness Trading Pvt. Ltd. The app is going to be one platform that aims to bridge the gap between farmers and B2B consumers. Our company is providing a door-to-door supply chain facility with integrated waste management...</p>
                </div>
            </div>
        </div>
    </section>
    ...
    @include('front.widget.testimonials')
